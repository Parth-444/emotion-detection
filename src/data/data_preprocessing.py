...
def main():
    ...
    train_data, test_data = load_data(train_path='./data/raw/train_data.csv', test_path='./data/raw/test_data.csv')
    ...
    save_data(data_path=data_path, train_processed_data=train_processed_data, test_processed_data=test_processed_data)
